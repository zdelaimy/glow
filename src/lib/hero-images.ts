export const heroSlides = [
  {
    ...
    subtitle: "Premium skincare, clean ingredients.",
  },
  {
    src: "/hero/videos/second.mp4",
    alt: "Beauty products and lifestyle",
    headline: "Fewer products. Better results.",
    subtitle: "A curated collection of premium beauty essentials — nothing extra, nothing unnecessary.",
  },
  {
    src: "/hero/videos/third.mp4",
    alt: "Woman sharing beauty tips",
    headline: "Clean beauty, real results.",
    subtitle: "Formulated for every skin type. Designed to make you feel amazing.",
  },
  {
    src: "/hero/videos/fourth.mp4",
    alt: "Women collaborating together",
    headline: "Beauty you can trust.",
    subtitle: "Dermatologist tested. Free from parabens, sulfates, and harsh chemicals.",
  },
]
