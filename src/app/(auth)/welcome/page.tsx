...
export default function WelcomePage() {
  ...
  async function handleVerifyOtp(e: React.FormEvent) {
    ...
    if (user) {
      ...
      // Keep loading state active — router.push will unmount this page
      return
    }
        ...
        <div className="relative z-10 px-16 max-w-lg">
          ...
          >
            ...
            <p className="text-[#6E6A62]/60 text-base leading-relaxed mb-12 max-w-sm">
              That&apos;s the goal. Open your storefront, share products you love, and earn commissions on every sale.
            </p>
