...
export default async function BecomeAGlowGirlPage({
  searchParams,
}: {
  ...
  return (
    <div className="min-h-screen bg-[#f5f0eb]">
      <LandingHeader variant="hero" ctaHref="/" ctaLabel="Shop" />
          ...
          <div className="inline-flex animate-[marquee_40s_linear_infinite]">
            {[...Array(2)].map((_, i) => (
              <span key={i} className="text-xs uppercase tracking-[0.2em] text-[#6E6A62] font-medium font-inter">
                $10K in Sales in 10 Weeks · 10 Hrs/Week&ensp;&bull;&ensp;Earn 25% Commission&ensp;&bull;&ensp;$0 to Start&ensp;&bull;&ensp;$10K in Sales in 10 Weeks · 10 Hrs/Week&ensp;&bull;&ensp;Earn 25% Commission&ensp;&bull;&ensp;$0 to Start&ensp;&bull;&ensp;
              </span>
            ))}
          </div>
        </div>
        ...
        <section className="bg-white py-24 md:py-32">
          <div className="max-w-5xl mx-auto px-6">
            <div className="bg-[#f5f0eb] rounded-2xl p-8 md:p-14 border border-neutral-200">
              <h2 className="text-3xl md:text-4xl leading-tight text-[#6E6A62] mb-10 text-center">
            ...
            <div className="grid md:grid-cols-3 gap-12 md:gap-16">
              {[
                ...
                <div key={item.step} className="flex flex-col items-center">
                  ...
                  <h3 className="text-xs uppercase tracking-[0.2em] font-semibold mb-3 text-[#6E6A62] font-sans">
                    {item.title}
                  </h3>
